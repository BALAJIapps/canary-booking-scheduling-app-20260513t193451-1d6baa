...
export default function QuickAddSlot() {
  ...
  if (!open) {
    return (
      ...
      >
        <Save className="h-3.5 w-3.5 mr-2" strokeWidth={1.7} />
        Save new slot
      </Button>
    );
  }
  ...
  return (
    <form
      ...
      className="rounded-xl border border-[rgba(34,42,53,0.08)] p-5 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_0_0_1px_rgba(34,42,53,0.08),0_4px_8px_rgba(34,42,53,0.05)] max-w-md"
    >
      ...
      {success && (
        <div className="mt-3 flex items-center gap-2 text-green-700">
          ...
          <span className="text-[12px]">Slot saved successfully!</span>
        </div>
      )}
      ...
      <div className="mt-4 flex items-center gap-2">
        ...
        >
          {loading ? (
            ...
            <><Save className="h-3.5 w-3.5 mr-2" />Save slot</>  
          )}
        </Button>
        <Button
          type="button"
          ...
          className="text-[13px] h-9 text-[#898989]"
        >
          Cancel
        </Button>
      </div>
